...
export default function AppealsList() {
  ...
  const effectiveSearch = advFilters.searchText.trim() || search;
  ...
  }, [appeals, effectiveSearch, advFilters]);
        ...
        <Box sx={{
          ...
          <Box sx={{ flexShrink: 0, width: { xs: '100%', md: 600 }, p: 2 }}>
            ...
            <FloorPlanViewer
                ...
                onCameraClick={cam => setSelHardware(cam.hardwareId)}
            />
